...
\begin{itemize}
\item Hasonlóan az események feldolgozásához, úgy a portokon történű üzenetáramlást is átmeneti függvényekkel dolgozzuk fel. Ez esetben nem érdekes számunka a port állapota, az üzenet az objektum üzenetsorába kerül be, mely majd feldolgozásra kerül hasonlóan, mint egy normál üzenet.  \\
...
\item Az interfészeket sehol máshol sem tudjuk felhasználni, osztályok sem tudják megvalósítani őket, mely szintén a modellel való kommunikációban jelent hátrányt, illetve annak későbbi kiterjesztésében. 
\end{itemize}
...
\bibitem{txtUML}
  ...
  \emph{Textual, executable, translatable UML}, article, page 10,
...
\bibitem{alf}
	...
	standard , version 1.1, page 407, June 2017\\
...
\bibitem{pscs}
	...
	standard, version 1.1, page 158, March 2018\\
