...
protected:
	...
	virtual void recive(EventPtr signal) = 0;
...
template <typename RequiredInf, typename ProvidedInf>
class IPort : public RequiredInf, protected MessageReciver
{
public:
	template <typename RequiredInf, typename ProvidedInf>
...
class BehavionPortImpl : public BehaviorPort <RequiredInf, ProvidedInf>
{
    ...
    protected:
        ...
        virtual void recive(EventPtr signal)
        {
...
template <typename RequiredInf, typename ProvidedInf>
IPort<ProvidedInf, RequiredInf> * createInvertedPort(IPort<RequiredInf, ProvidedInf> * sourcePort)
{
	IPort<StartInf, EmptyInf>* createdPort = new PortImpl<ProvidedInf, RequiredInf>();
	connect (createdPort, sourcePort);
	return createdPort;
}
